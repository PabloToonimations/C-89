...
export default class StoryScreen extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      light_theme: true,
      //establecer false antes de que el botón sea presionado
      is_liked: false,
      //variable que guarda los likes
        ...
        >
          ...
          <View style={styles.storyContainer}>
            ...
            >
              ...
              /*el código para nuestro botón "me gusta" para revisar si se ha dado clic o no*/
...
const styles = StyleSheet.create({
  ...
  //agregar estilo a nuestro botón de like
  likeButtonLiked: {
    flexDirection: 'row',
    width: RFValue(160),
    height: RFValue(40),
  ...
  //agregar estilo a nuestro botón de dislike
  likeButtonDisliked: {
    flexDirection: 'row',
    width: RFValue(160),
    height: RFValue(40),
